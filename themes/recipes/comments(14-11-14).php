...
<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" class="contact_id"  >
		        ...
		        <p>
		                ...
		                <input type="text" name="author" id="author" value="<?php echo esc_attr($comment_author); ?>" autofocus class="field" />
		        </p>
		        <p>
		                <label for="email"><?php _e('Your Email', 'FoodRecipe'); ?> <span>*</span></label>
		                <input type="email" name="email" id="comment_email" value='<?php echo esc_attr($comment_author_email); ?>'  class="field comment_email"  required autofocus />
		        </p>
		        <p>
