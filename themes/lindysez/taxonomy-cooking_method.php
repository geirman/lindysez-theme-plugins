<?php get_header(); ?>
<!-- CG: taxonomy-cooking_method.php -->
					<div class="col-xs-12 col-sm-12 col-md-8 all_reciepe">					
									
								<h1>
								<?php 
									$current_term = get_term_by( 'slug', get_query_var('term') ,'cooking_method' );								
									echo __('Cooking Method: ','FoodRecipe').' <span>'.$current_term->name.'</span>'; 
								?>
								</h1>
