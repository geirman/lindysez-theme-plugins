...
$slider_timing = ot_get_option( 'slider_type_timing');
 ...
 $ipad_slider_timing = ot_get_option( 'slider_ipad_timing');
 if(empty($ipad_slider_timing)):
	$ipad_slider_timing='7000';
 endif;
...
<script>
    ...
    jQuery('.pagination').on('click',function() {
        ...
        mySwiper.params.autoplay = '<?=$ipad_slider_timing?>';
